...
export default function Account() {
    return(
        <div className="dropdown login">
            <button type="button" className="accountbtn dropdown-toggle" id="dropdownLoginButton" data-toggle="dropdown" aria-haspopup="true"><span class="bi bi-person-fill"></span></button>
