    ...
    return(
        <div className="au-footer">
            <div className="contact-footer">
                ...
                <p><span class='bi bi-telephone-outbound-fill'></span><a id="phone_number" href="#">+996 (0)505 888 765</a></p>
                <p><span class='bi bi-envelope-fill'></span><a id="email" href="mailto:k.otonbaev@gmail.com">k.otonbaev@gmail.com</a></p>
                <p><span class='bi bi-pin-map-fill'></span><a id="website" href="#">www.au-travel.kg</a></p>
            </div>
